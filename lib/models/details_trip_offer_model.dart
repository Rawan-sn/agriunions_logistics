...
class TripDetailsOfferModel {
  ...
  factory TripDetailsOfferModel.fromMap(Map<String, dynamic> map) {
    TripDetailsOfferModel model = TripDetailsOfferModel(
      id: map['id'],
      number: map['number'],
  ...
  factory TripDetailsOfferModel.fromJson(String source) =>
      TripDetailsOfferModel.fromMap(json.decode(source));
}
