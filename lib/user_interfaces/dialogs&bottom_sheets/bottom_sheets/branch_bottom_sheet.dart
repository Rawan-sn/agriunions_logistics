...
class BranchBottomSheet extends StatefulWidget {
  @override
  _BranchBottomSheetState createState() => _BranchBottomSheetState();
}

class _BranchBottomSheetState extends State<BranchBottomSheet> {
    ...
    return Column(
      children: [
        Container(
          ...
          child: Center(
            child: Text(
              AppLocalizations.of(context)!.trans("choose_branch")! + "..",
