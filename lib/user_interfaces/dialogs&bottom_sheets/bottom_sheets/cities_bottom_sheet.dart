...
import 'package:agriunions_logistics/blocs/cities_bloc.dart';
...
class _CitiesBottomSheetState extends State<CitiesBottomSheet> {
  CitiesBloc _bloc = CitiesBloc();

  @override
  void initState() {
    _bloc.getCitiesList(context, dataStore.country!.id);
    super.initState();
  }
    ...
    return Column(
      children: [
        Container(
          ...
          child: Center(
            child: Text(
              AppLocalizations.of(context)!.trans("choose_city")! + "..",
